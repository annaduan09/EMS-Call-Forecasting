...
Figure 1 shows that our model has similar MAE across different hours of the day and week. Figure 2, however, shows that while the average MAE of our model is around 0.015, a select few fishnet grids have error of up to 4x this amount. Figure 3 confirms this. This is concerning, and it requires that we look more closely at where these large errors are occuring, and to whom.  
...
Almost no difference in error across income, age, race, and health groups.
