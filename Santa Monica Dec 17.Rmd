...
## Temporal Lag
Temporal lag lets us examine temporal correlation in EMS calls. For instance, lagHour is the EMS calls last hour and here it can be used to predict the calls that are likely to happen this hour. In Figure XX, we see that 15 minute lag appears to correlate with EMS count.   
...
#BC: i guess we delete some data when doing na.omit
