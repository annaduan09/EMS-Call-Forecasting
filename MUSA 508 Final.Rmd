...
To watch our *pitch deck video for Siren*, the app we made with this algorithm, please click [here](youtube.com).
...
```{r Figure 8: EMS call by Rush, fig.height=4, fig.width=5, message=FALSE, warning=FALSE, results='hide'}
...
EMS_2020 %>% 
  ...
  ggplot()+
  geom_histogram(aes(mean_trips), binwidth = 1, color = "pink")+
...
reg.ss.cv <- crossValidate(
  ...
  indVariables = reg.ss.vars) %>%
    dplyr::select(cvID = cvID, EMS_Count, Prediction, geometrx)
